    ...
    <div class="relative">
        ...
        <div class="absolute top-0 left-0 w-full h-full flex flex-col justify-center items-center text-center bg-black bg-opacity-50">
            ...
            <div class="mt-4 flex space-x-4">
                ...
                <form action="/homepage" method="GET" class="mt-6">
                    <input type="text" placeholder="Cari Destinasi" name="search" class="border-none p-3 rounded-lg w-72">
                    <button class="bg-blue-500 text-white px-6 py-3 rounded-lg hover:bg-blue-700" type="submit">Cari</button>
                </form>
