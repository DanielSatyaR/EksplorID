    ...
    <div class="">
      <nav aria-label="Breadcrumb">
        <ol role="list" class="mx-auto flex max-w-2xl items-center space-x-2 px-4 sm:px-6 lg:max-w-7xl lg:px-8 mt-5 mb-10 ml-8">
          ...
          <div class="flex items-center">
            <a href="/semarang" class="mr-2 text-sm font-medium text-gray-500">Semarang</a>
            <svg width="16" height="20" viewBox="0 0 16 20" fill="currentColor" aria-hidden="true" class="h-5 w-4 text-gray-300">
              <path d="M5.697 4.34L8.98 16.532h1.327L7.025 4.341H5.697z" />
            </svg>
          </div>
          ...
          <li class="text-sm">
            <a href="/semarang/saloka" aria-current="page" class="font-medium text-gray-500 hover:text-gray-600">Saloka Theme Park</a>
          </li>
        </ol>
      </nav>
      ...
      <div class="mx-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:grid-rows-[auto_auto_1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-3">
        <div class="lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8 mb-10 ml-7">
          <h1 class="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Tiket Saloka Theme Park</h1>
        </div>
        ...
        <div class="grid grid-cols-4 gap-4 mt-15 lg:px-8">
          ...
          <div class="col-span-2 row-span-2">
            <img src="../img/semarang/saloka/saloka.jpg" alt="Gambar besar" class="w-full h-full object-cover rounded-lg shadow-md">
          </div>

          <!-- Gambar kecil -->
          <div>
            <img src="../img/semarang/saloka/saloka1.png" alt="dago1" class="w-full h-full object-cover rounded-lg shadow-md">
          </div>
          <div>
            <img src="../img/semarang/saloka/saloka2.png" alt="dago2" class="w-full h-full object-cover rounded-lg shadow-md">
          </div>
          <div>
            <img src="../img/semarang/saloka/saloka3.png" alt="dago3" class="w-full h-full object-cover rounded-lg shadow-md">
          </div>
          <div>
            <img src="../img/semarang/saloka/saloka4.png" alt="dago4" class="w-full h-full object-cover rounded-lg shadow-md">
          </div>
        </div>
      ...
      <section id="deskripsi"></section>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6 flex flex-col lg:flex-row justify-between">
          ...
          <div class="lg:w-3/4 bg-white rounded-lg shadow p-6">
            <div class="mb-4">
              <i class="fa-solid fa-location-dot mr-3 p-2"></i>Jl. Fatmawati No.154, Gumuksari, Lopait, Tuntang, Semarang,..
            ...
            Nikmati petualangan di Semarang di Saloka Theme Park! Saloka Theme Park menghadirkan 25 atraksi seru yang tersebar di lima zona menarik: Zona Pesisir, Zona Balalantar, Zona Segara Prada, Zona Ararya, dan Zona Kamayayi. Rasakan kegembiraan nostalgia di Cakrawala, ferris wheel klasik, ikuti pertempuran air seru di Semprat-Semprot, atau biarkan buah hati bermain sambil belajar di Lumbung Ilmu Galileo. Bagi yang berani, tantang diri kamu untuk memasuki wahana Adu Nyali, sebuah rumah hantu yang akan menguji keberanianmu.
            Setelah hari yang penuh petualangan, nikmati lezatnya jajanan lokal di berbagai warung kuliner di sini. Dengan beragam wahana yang menarik untuk segala usia, kamu harus mencoba liburan di Saloka Theme Park dan mengajak seluruh keluarga biar makin seru!
          </div>
      ...
      <section id="tiket"></section>
          ...
          <div class="max-w-3xl mt-6 bg-white rounded-lg p-6 border shadow-xl md:flex-row">
            <div class="flex justify-between items-center">
              <div>
                ...
                <p class="text-sm text-gray-500">Tiket masuk ke Saloka Theme Park untuk 1 orang pengunjung</p>
              </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
          <h2 class="text-lg font-bold mb-4">Jelajahi Wisata Lainnya yang ada di Semarang</h2>

          <div class="mx-xl max-w-2xl grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <a href="/malang/jatim1" class="group border-2 rounded-md">
              <img src="../img/jatimpark1.png" alt="dranch" class="aspect-square w-full rounded-lg bg-gray-200 object-cover group-hover:opacity-75 xl:aspect-[6/6] rounded-b-none">
