    ...
    <div class="">
      <nav aria-label="Breadcrumb">
        <ol role="list" class="mx-auto flex max-w-2xl items-center space-x-2 px-4 sm:px-6 lg:max-w-7xl lg:px-8 mt-5 mb-10 ml-8">
          ...
          <li class="text-sm">
            <a href="/yogyakarta/borobudur" aria-current="page" class="font-medium text-gray-500 hover:text-gray-600">Candi Borobudur</a>
          </li>
        </ol>
      </nav>
      ...
      <div class="mx-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:grid-rows-[auto_auto_1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-3">
        <div class="lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8 mb-10 ml-7">
          <h1 class="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Tiket Candi Borobudur</h1>
        </div>
        ...
        <div class="grid grid-cols-4 gap-4 mt-15 lg:px-8">
          ...
          <div class="col-span-2 row-span-2">
            <img src="../img/yogyakarta/borobudur/candiB.jpg" alt="Gambar besar" class="w-full h-full object-cover rounded-lg shadow-md">
          </div>

          <!-- Gambar kecil -->
          <div>
            <img src="../img/yogyakarta/borobudur/candib1.png" alt="dago1" class="w-full h-full object-cover rounded-lg shadow-md">
          </div>
          <div>
            <img src="../img/yogyakarta/borobudur/candib2.png" alt="dago2" class="w-full h-full object-cover rounded-lg shadow-md">
          </div>
          <div>
            <img src="../img/yogyakarta/borobudur/candib3.png" alt="dago3" class="w-full h-full object-cover rounded-lg shadow-md">
          </div>
          <div>
            <img src="../img/yogyakarta/borobudur/candib4.png" alt="dago4" class="w-full h-full object-cover rounded-lg shadow-md">
          </div>
        </div>
      ...
      <section id="deskripsi"></section>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6 flex flex-col lg:flex-row justify-between">
          ...
          <div class="lg:w-3/4 bg-white rounded-lg shadow p-6">
            <div class="mb-4">
              <i class="fa-solid fa-location-dot mr-3 p-2"></i>Jl. Badrawati, Kw. Candi Borobudur, Borobudur, Kec. Borobudur, Kabupaten Magelang,..
            ...
            Selami dunia masa lalu dengan berkunjung ke situs bersejarah Candi Borobudur, candi Buddha terbesar di dunia!
            Kaya akan Sejarah: Benamkan diri Anda dalam kekayaan sejarah dan budayanya saat Anda menaiki candi utama yang berbentuk piramida. Perhatikan baik-baik dan kagumi ribuan pahatan batu yang menggambarkan citra Buddha dan kehidupan orang Jawa dari ribuan tahun yang lalu.
            Arsitektur Luar Biasa Megah: Candi berbentuk piramida ini memiliki struktur kompleks yang didesain sedemikian rupa. Kemegahan dan keindahannya makin terasa dengan ukiran batu yang penuh makna di setiap dinding candi.
            Warisan Dunia: Candi Borobudur yang dibangun pada abad ke-9 pada masa pemerintahan Dinasti Syailendra Kerajaan Medang ini termasuk ke dalam Situs Warisan Dunia UNESCO.
            Kunjungi candi yang terkenal hingga ke mancanegara ini untuk melihat warisan masa lalu dengan keindahan yang unik.
            </p>
          </div>
      ...
      <section id="tiket"></section>
          ...
          <div class="max-w-3xl mt-6 bg-white rounded-lg p-6 border shadow-xl md:flex-row">
            <div class="flex justify-between items-center">
              <div>
                ...
                <p class="text-sm text-gray-500">Tiket masuk ke Candi Borobudur untuk 1 orang pengunjung</p>
              </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
          ...
          <div class="mx-xl max-w-2xl grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <a href="/yogyakarta/prambanan" class="group border-2 rounded-md">
              <img src="../img/candip.jpg" alt="dranch" class="aspect-square w-full rounded-lg bg-gray-200 object-cover group-hover:opacity-75 xl:aspect-[6/6] rounded-b-none">
              <h2 class="mt-1 text-lg font-bold text-gray-900">Candi Prambanan</h2>
              <p class="mt-4 text-sm text-gray-700"> Sleman Regency, Yogyakarta</p>
