    ...
    <div class="">
      <nav aria-label="Breadcrumb">
        <ol role="list" class="mx-auto flex max-w-2xl items-center space-x-2 px-4 sm:px-6 lg:max-w-7xl lg:px-8 mt-5 mb-10 ml-8">
          ...
          <li class="text-sm">
            <a href="/jakarta/aquarium" aria-current="page" class="font-medium text-gray-500 hover:text-gray-600">Jakarta Aquarium Safari</a>
          </li>
        </ol>
      </nav>
      ...
      <div class="mx-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:grid-rows-[auto_auto_1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-3">
        <div class="lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8 mb-10 ml-7">
          <h1 class="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Tiket Jakarta Aquarium Safari</h1>
        </div>
        ...
        <div class="grid grid-cols-4 gap-4 mt-15 lg:px-8">
          ...
          <div class="col-span-2 row-span-2">
            <img src="../img/jakarta/aquarium/jktaqua.jpeg" alt="Gambar besar" class="w-full h-full object-cover rounded-lg shadow-md">
          </div>

          <!-- Gambar kecil -->
          <div>
            <img src="../img/jakarta/aquarium/jktqua1.png" alt="dago1" class="w-full h-full object-cover rounded-lg shadow-md">
          </div>
          <div>
            <img src="../img/jakarta/aquarium/jktqua2.png" alt="dago2" class="w-full h-full object-cover rounded-lg shadow-md">
          </div>
          <div>
            <img src="../img/jakarta/aquarium/jktqua3.png" alt="dago3" class="w-full h-full object-cover rounded-lg shadow-md">
          </div>
          <div>
            <img src="../img/jakarta/aquarium/jktqua4.png" alt="dago4" class="w-full h-full object-cover rounded-lg shadow-md">
          </div>
        </div>
      ...
      <section id="deskripsi"></section>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6 flex flex-col lg:flex-row justify-between">
          ...
          <div class="lg:w-3/4 bg-white rounded-lg shadow p-6">
            <div class="mb-4">
              <i class="fa-solid fa-location-dot mr-3 p-2"></i>Letjen S. Parman Street, RW.5, South Tanjung Duren, West Jakarta City, Jakarta, Indonesia,...
            ...
            Ingin merasakan serunya menjelajahi keindahan dunia bawah laut dan bertemu satwa darat eksotis di satu tempat? Jakarta Aquarium & Safari adalah jawabannya! Berlokasi strategis di Neo Soho Mall, Jakarta Barat, destinasi wisata indoor ini menghadirkan pengalaman tak terlupakan yang memadukan rekreasi, edukasi, dan petualangan bagi seluruh keluarga.
            Ayo, jadikan akhir pekanmu lebih berkesan bersama Jakarta Aquarium & Safari! Bertualang, belajar, dan berfoto seru dengan satwa favoritmu dalam satu tempat. Pesan tiket sekarang dan rasakan keseruannya!
            </p>
          </div>
      ...
      <section id="tiket"></section>
          ...
          <div class="max-w-3xl mt-6 bg-white rounded-lg p-6 border shadow-xl md:flex-row">
            <div class="flex justify-between items-center">
              <div>
                ...
                <p class="text-sm text-gray-500">Tiket masuk ke Jakarta Aquarium Safari untuk 1 orang pengunjung</p>
              </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
          ...
          <div class="mx-xl max-w-2xl grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <a href="/jakarta/TamanMini" class="group border-2 rounded-md">
              <img src="../img/tmi.jpg" alt="dranch" class="aspect-square w-full rounded-lg bg-gray-200 object-cover group-hover:opacity-75 xl:aspect-[6/6] rounded-b-none">
              <h2 class="mt-1 text-lg font-bold text-gray-900">Taman Mini Indonesia</h2>
              <p class="mt-4 text-sm text-gray-700"> Jakarta Timur, Daerah Khusus Ibukota Jakarta</p>
