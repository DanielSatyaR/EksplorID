    ...
    <div class="">
      <nav aria-label="Breadcrumb">
        <ol role="list" class="mx-auto flex max-w-2xl items-center space-x-2 px-4 sm:px-6 lg:max-w-7xl lg:px-8 mt-5 mb-10 ml-8">
          ...
          <div class="flex items-center">
            <a href="/bali" class="mr-2 text-sm font-medium text-gray-500">Bali</a>
            <svg width="16" height="20" viewBox="0 0 16 20" fill="currentColor" aria-hidden="true" class="h-5 w-4 text-gray-300">
              <path d="M5.697 4.34L8.98 16.532h1.327L7.025 4.341H5.697z" />
            </svg>
          </div>
          ...
          <li class="text-sm">
            <a href="/bali/balibird" aria-current="page" class="font-medium text-gray-500 hover:text-gray-600">bali Bird Park</a>
          </li>
        </ol>
      </nav>
      ...
      <div class="mx-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:grid-rows-[auto_auto_1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-3">
        <div class="lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8 mb-10 ml-7">
          <h1 class="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Tiket Bali Bird Park</h1>
        </div>
        ...
        <div class="grid grid-cols-4 gap-4 mt-15 lg:px-8">
          ...
          <div class="col-span-2 row-span-2">
            <img src="../img/balibird/balibird.png" alt="Gambar besar" class="w-full h-full object-cover rounded-lg shadow-md">
          </div>

          <!-- Gambar kecil -->
          <div>
            <img src="../img/bali/balibird/balibird1.png" alt="dago1" class="w-full h-full object-cover rounded-lg shadow-md">
          </div>
          <div>
            <img src="../img/bali/balibird/balibird2.png" alt="dago2" class="w-full h-full object-cover rounded-lg shadow-md">
          </div>
          <div>
            <img src="../img/bali/balibird/balibird3.png" alt="dago3" class="w-full h-full object-cover rounded-lg shadow-md">
          </div>
          <div>
            <img src="../img/bali/balibird/balibird4.png" alt="dago4" class="w-full h-full object-cover rounded-lg shadow-md">
          </div>
        </div>
      ...
      <section id="deskripsi"></section>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6 flex flex-col lg:flex-row justify-between">
          ...
          <div class="lg:w-3/4 bg-white rounded-lg shadow p-6">
            <div class="mb-4">
              <i class="fa-solid fa-location-dot mr-3 p-2"></i>Jl. Serma Cok Ngurah Gambir Singapadu, Batubulan,..
            ...
            Jadikan liburan bersama keluarga atau teman lebih berkesan dengan mengunjungi Bali Bird Park!
            Terletak di lahan seluas 2 hektar di Singapadu Village, Gianyar Regency, taman ini menawarkan pengalaman yang unik dengan berbagai spesies burung dan reptil.
            Dengan 1.300 burung dari lebih dari 250 spesies, mulai dari Borneo hingga Afrika, Anda akan merasakan keajaiban alam yang tak terlupakan. Taman burung ini dikelola oleh tim ahli dari seluruh dunia. Anda dapat memberi makan, berfoto bersama, dan bahkan melihat bayi burung yang menetas di konservasi ini.
            </p>
          </div>
      ...
      <section id="tiket"></section>
          ...
          <div class="max-w-3xl mt-6 bg-white rounded-lg p-6 border shadow-xl md:flex-row">
            <div class="flex justify-between items-center">
              <div>
                ...
                <p class="text-sm text-gray-500">Tiket masuk ke Bali Bird Park untuk 1 orang pengunjung</p>
              </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
          <h2 class="text-lg font-bold mb-4">Jelajahi Wisata Lainnya yang ada di Bali</h2>

          <div class="mx-xl max-w-2xl grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <a href="/bali/balisafari" class="group border-2 rounded-md">
              <img src="../img/balisafari/balisafari5.png" alt="dranch" class="aspect-square w-full rounded-lg bg-gray-200 object-cover group-hover:opacity-75 xl:aspect-[6/6] rounded-b-none">
              <h2 class="mt-1 text-lg font-bold text-gray-900">Bali Safari Park</h2>
              <p class="mt-4 text-sm text-gray-700"> Gianyar, Kabupaten Gianyar, Bali</p>
