          ...
          <div class="ml-4 flex items-center md:ml-6">
            ...
            <div class="relative ml-3">
              ...
              class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black/5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
                ...
                <a href="/login" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-0">Masuk</a>
                <a href="/createacc" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-2">Daftar Akun</a>
              </div>
            </div>
          </div>
        </div>
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu" >
      ...
      <div class="border-t border-gray-700 pb-3 pt-4">
        ...
        <div class="mt-3 space-y-1 px-2">
          <a href="/login" class="block rounded-md px-3 py-2 text-base font-medium text-black-400  hover:text-gray-500">Masuk</a>
          <a href="/create" class="block rounded-md px-3 py-2 text-base font-medium text-black-400  hover:text-gray-500">Daftar Akun</a>
        </div>
      </div>
    </div>
  </nav>
